...
//skrur av lyden på siden
function pauseLyd()
{
  var lyd = document.getElementById("lydfil");//setter en variabel til lydfilen som kjøres
  if(lyd.muted==true)//sjekker om lyden er skrudd av
  {
    lyd.muted=false;//skrur på lyden
    stille.src="../Bilder/Speaker.png";//gir bilde til lyd-knappen
  }
  else
  {
    lyd.muted=true;//skrur av lyden
    stille.src="../Bilder/no-sound.png";//gir bilde til lyd-knappen
  }
  stille.blur();//fjerner fokus fra knappen så den ikke skrus av/på ved trykk på enter
}
